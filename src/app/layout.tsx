...
export const metadata: Metadata = {
  ...
  description:
    "Découvrez La Classe Américaine, le chef-d'œuvre méconnu de Michel Hazanavicius avec les vrais doubleurs français des stars hollywoodiennes. Un film culte qui mélange humour et cinéma d'auteur.",
  keywords: [
  ...
  openGraph: {
    title: "La Classe Américaine - L'homme le plus classe du monde",
    description:
      "Le chef-d'œuvre méconnu de Michel Hazanavicius. Découvrez l'histoire de George Abitbol, l'homme le plus classe du monde.",
